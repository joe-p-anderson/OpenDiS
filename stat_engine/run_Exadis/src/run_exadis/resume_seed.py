...
from run_exadis.sim_utils import (
    archive_data, find_last_restart_file, find_restart_file, 
    pyexadis, read_config, reload_config, run_simulation, 
    read_restart, strip_stress_strain
    )

data_directory = Path("data/")

def resume_from_seed(which_seed="100", axis_str="001",restart_id=None,use_root_config=False):
    ...
    config = read_config() if use_root_config else reload_config(output_path, which_seed, axis_str)
